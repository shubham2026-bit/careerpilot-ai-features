  ...
  return (
    <section className="py-20 lg:py-32">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-4xl lg:text-5xl font-bold">Loved by Career Professionals</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {TESTIMONIALS.map((testimonial, index) => (
            ...
            >
              <Card className="p-6 flex flex-col h-full hover:border-accent/50 transition-all hover:shadow-lg">
                {/* Stars */}
